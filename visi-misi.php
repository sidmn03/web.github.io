...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <div class="card">
                <h1>Visi</h1>
                <img class="img-2" src="image/visi.jpg" alt="">
                <p class="lead">Membangun legenda kami dan memimpin industri kami melalui inovasi, evolusi, dan perasaan</p>
                <h1>Misi</h1>
                <img class="img-2" src="image/misi.jpg" alt="">
                <p>Lebih dari sekadar membangun mesin, kami adalah simbol upaya meraih petualangan abadi. kebebasan bagi jiwa.</p>
                <br><br><br><br>
            </div>
        </div>
    </div>
